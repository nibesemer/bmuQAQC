...
```{r bounds}
kable(bounds, format = "html", booktabs = TRUE, longtable = TRUE) %>% kable_styling(latex_options = c("striped", "hold_position", "repeat_header"))
```


```{r}
kable(summary.samples, format = "html", booktabs = TRUE, longtable = TRUE) %>% kable_styling(latex_options = c("striped", "hold_position", "repeat_header","scale_down") , font_size = 8)
```
